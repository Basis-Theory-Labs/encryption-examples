...
example-04:
	docker-compose -f src/04-key-rotation/docker-compose.yml --project-directory src/04-key-rotation down -v
	docker-compose -f src/04-key-rotation/docker-compose.yml --project-directory src/04-key-rotation up -d --build

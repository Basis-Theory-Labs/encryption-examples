...
public class KeyVaultKeyManagementService : IKeyManagementService
{
    ...
    private readonly IOptionsMonitor<KeyVaultKeyManagementServiceOptions> _options;

    public KeyVaultKeyManagementService(KeyClient keyClient, IOptionsMonitor<KeyVaultKeyManagementServiceOptions> options)
    {
